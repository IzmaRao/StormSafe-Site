...
const nextConfig = {
  images: {
    domains: ['images.nationalgeographic.org','encrypted-tbn0.gstatic.com','m.economictimes.com','upload.wikimedia.org','media.wired.com','static.vecteezy.com','static6.depositphotos.com','www.strokecommunityalliance.org','www.researchgate.net','www.verywellhealth.com'],
  },
  async redirects() {
    return [
      {
